...
EPOCHS_STAGE1 = 15
EPOCHS_STAGE2 = 10
DATASET_DIR = "dataset_large_rebalanced"
SEED = 42
...
# Save class order
with open("class_names_final.txt", "w") as f:
    for name in class_names:
        f.write(name + "\n")
...
# SAVE MODEL
# -------------------------
model.save("lost_and_found_classifier12.keras")
...
# -------------------------
plt.figure(figsize=(8, 4))
plt.plot(history1.history["accuracy"], label="Stage1 Train")
plt.plot(history1.history["val_accuracy"], label="Stage1 Val")
plt.legend()
